...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('2.png') }}?v=1">
    <link rel="shortcut icon" type="image/png" href="{{ asset('2.png') }}?v=1">
    <link rel="apple-touch-icon" href="{{ asset('2.png') }}?v=1">
